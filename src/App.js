...
const avatarClasses = ['objectFitCover', 'objectFitContain', 'none'];
...
const handleAvatar = () => {
setAvatarClassIndex((prevIndex) => (prevIndex + 1) % avatarClasses.length);
};
...
// **Corrected: Use avatarClasses[avatarClassIndex] to display images**
className={avatarClasses[avatarClassIndex]}
